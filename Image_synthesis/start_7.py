...
for i_1 in list_1:
    im_1=Image.open((flie_path+'/../../coverage_7/{0}').format(i_1))
    image_1=im_1.copy()#打开第1张

    for i_2 in list_2:
        im_2=Image.open((flie_path+'/../../coverage_6/{0}').format(i_2))
        image_2=im_2.copy()#打开第2张

        for i_3 in list_3:
            im_3=Image.open((flie_path+'/../../coverage_5/{0}').format(i_3))
            image_3=im_3.copy()#打开第3张

            for i_4 in list_4:
                im_4=Image.open((flie_path+'/../../coverage_4/{0}').format(i_4))
                image_4=im_4.copy()#打开第4张

                for i_5 in list_5:
                    im_5=Image.open((flie_path+'/../../coverage_3/{0}').format(i_5))
