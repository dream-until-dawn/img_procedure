...
for i_1 in list_1:
    im_1=Image.open((flie_path+'/../../coverage_9/{0}').format(i_1))
    image_1=im_1.copy()#打开第1张

    for i_2 in list_2:
        im_2=Image.open((flie_path+'/../../coverage_8/{0}').format(i_2))
        image_2=im_2.copy()#打开第2张

        for i_3 in list_3:
            im_3=Image.open((flie_path+'/../../coverage_7/{0}').format(i_3))
            image_3=im_3.copy()#打开第3张

            for i_4 in list_4:
                im_4=Image.open((flie_path+'/../../coverage_6/{0}').format(i_4))
                image_4=im_4.copy()#打开第4张

                for i_5 in list_5:
                    im_5=Image.open((flie_path+'/../../coverage_5/{0}').format(i_5))
                    image_5=im_5.copy()#打开第5张

                    for i_6 in list_6:
                        im_6=Image.open((flie_path+'/../../coverage_4/{0}').format(i_6))
                        image_6=im_6.copy()#打开第6张

                        for i_7 in list_7:
                            im_7=Image.open((flie_path+'/../../coverage_3/{0}').format(i_7))
                            image_7=im_7.copy()#打开第7张

                            for i_8 in list_8:
                                im_8=Image.open((flie_path+'/../../coverage_2/{0}').format(i_8))
                                image_8=im_8.copy()#打开第8张

                                for i_9 in list_9:
                                    im_9=Image.open((flie_path+'/../../coverage_1/{0}').format(i_9))
                                    ...
                                    #--------------------------------------------------------------------
                                    image_1.save(flie_path+'/../../save/{0}{1}{2}{3}{4}{5}{6}{7}{8}.png'.format(i_9[:-4],i_8[:-4],i_7[:-4],i_6[:-4],i_5[:-4],i_4[:-4],i_3[:-4],i_2[:-4],i_1[:-4]))
